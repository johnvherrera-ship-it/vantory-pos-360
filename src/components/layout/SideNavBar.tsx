...
export const SideNavBar = ({
  ...
  const DesktopNav = () => (
    <>
      ...
      <div className="mx-4 mb-4 px-3 py-2 bg-green-50/10 rounded-lg border border-green-500/30 flex items-center gap-2">
        <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
        <span className="text-[11px] font-semibold text-green-200">Conectado</span>
      </div>
  ...
  return (
    <>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-secondary border-t border-white/10 flex justify-around items-center px-2 py-2 shadow-2xl h-16">
