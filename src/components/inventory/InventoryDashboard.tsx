  ...
  return (
    <div className="flex min-h-screen bg-surface text-on-surface font-body">
      ...
      <button
        ...
        className="fixed bottom-8 right-8 w-16 h-16 bg-gradient-to-br from-blue-600 to-blue-800 text-white rounded-full shadow-2xl shadow-blue-600/40 flex items-center justify-center z-50 hover:scale-110 hover:shadow-xl active:scale-95 transition-all duration-200 cursor-pointer"
      >
