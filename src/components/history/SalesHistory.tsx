...
import { Search, Bell, Settings, LogOut, Printer, Trash2 } from 'lucide-react';
import { SideNavBar } from '../layout/SideNavBar';

export const SalesHistory = ({ setCurrentPage, salesHistory, setViewingSale, currentUser, users, setCurrentUser, currentStore, currentPOS }: { setCurrentPage: (page: any) => void, salesHistory: any[], setViewingSale: (sale: any) => void, currentUser: any, users: any[], setCurrentUser: any, currentStore: any, currentPOS: any }) => {
  return (
