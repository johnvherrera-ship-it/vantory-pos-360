              ...
              <div className="bg-surface-container-lowest p-6 border-t border-outline-variant/20">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    disabled={cart.length === 0}
                    className="flex items-center justify-center gap-2 py-4 bg-green-500 hover:bg-green-600 active:bg-green-700 text-white rounded-xl font-bold transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-md shadow-green-500/30 hover:shadow-lg"
                  >
                    <Banknote className="w-5 h-5" />
                    Efectivo (F10)
                  </button>
                  <button
                    ...
                    disabled={cart.length === 0}
                    className="flex items-center justify-center gap-2 py-4 bg-secondary hover:bg-blue-600 active:bg-blue-700 text-white rounded-xl font-bold transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-md shadow-secondary/30 hover:shadow-lg"
                  >
                  ...
                  <button
                    ...
                    disabled={cart.length === 0}
                    className="flex items-center justify-center gap-2 py-3 bg-orange-500 hover:bg-orange-600 active:bg-orange-700 text-white rounded-xl font-bold transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-md shadow-orange-500/30 hover:shadow-lg text-sm"
                  >
                  ...
                  <button
                    ...
                    disabled={cart.length === 0}
                    className="flex items-center justify-center gap-2 py-3 bg-pink-500 hover:bg-pink-600 active:bg-pink-700 text-white rounded-xl font-bold transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-md shadow-pink-500/30 hover:shadow-lg text-sm"
                  >
                    <CreditCard className="w-4 h-4" />
                    AmiPass
                  </button>
